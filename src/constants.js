...
Как пользоваться:
- для проверки готовности паспорта введи \`25-значный\` номер своего заявления, указанный в справке о приеме
- включить автообновление и оповещение можно, нажав \`Подписаться\` для каждого заявления
- отключить автообновление можно, нажав \`Отписаться\` и выбрав нужное заявление

Автообновление статусов заявлений происходит по расписанию:
  - Будние дни: 9:23, 12:23, 15:23, 17:23, 19:23, 21:23
  - Выходные дни: 16:17, 20:17
`,
  START: `
${DEFAULT_START}
